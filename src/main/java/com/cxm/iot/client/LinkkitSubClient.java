...
public class LinkkitSubClient {
    ...
    public static void deviceLinkkitClient(String productKey,String deviceName,String deviceSecret) {
//
//        final String productKey = "a1ppUE8HllR";
//        final String deviceName = "3pIi0cGStaWEgcBqYCUd";
//        final String deviceSecret = "lxlgOZ0Fb0NLp7q73inMTl1pbEy6zXqz";
